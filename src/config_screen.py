...
from models import ConfigBackgroundColourModel, ConfigCardbackModel
...
def solitaire_config_screen(game_state, config_manager):
    ...
    return ModelGroup(models=[static_model, menubar_model, background_colour_model, cardback_model])
